...
from exstracs.exstracs_classifierset import ClassifierSet
from exstracs.exstracs_prediction import *
from exstracs.exstracs_at import *
from exstracs.exstracs_rc import RuleCompaction
from exstracs.exstracs_classaccuracy import ClassAccuracy
from exstracs.exstracs_output import OutputFileManager
import copy
import random
import math
#------------------------------------------------------
...
class ExSTraCS:
    ...
    def doPopEvaluation(self, isTrain):
        ...
        # print ('ini ternyata balanced accuracy =',baccuracy)
        ...
        #-----------------------------------------------------------------------------------------------------------------------------------------
            ...
            print("writing balanced accurat to file..")
            with open("./Local_Output/balancedAccuracy.txt", "w") as text_file:
                print(f"Balanced accuracy: {adjustedBalancedAccuracy}", file=text_file)
